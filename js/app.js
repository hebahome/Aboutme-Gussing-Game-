...
function guessFav() {
  ...
  let userInput = prompt('can you guess my fav number');

  for (let i = 0; i < 4; i++) {
    //console.log(favNum + userInput);

    if (favNum === Number(userInput)) {
      alert('you guess my favourite');
    ...
    else if (Number(userInput) < favNum) {
      ...
      //{console.log(favNum + userInput);
      userInput = prompt('you type a one lower than my own');
    }

    else { userInput = prompt('you type a one  higher than my own'); }
